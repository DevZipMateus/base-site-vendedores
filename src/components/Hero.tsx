        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button 
              variant="outline" 
              onClick={handleEmail}
              className="border-blue-primary text-blue-primary hover:bg-blue-primary hover:text-background transition-all duration-300 text-lg px-6 py-3"
            >
        ...
        <div className="flex justify-center">
          <div className="relative">
            ...
            <img 
              ...
              alt="Daniel Escobar" 
              className="relative w-80 h-80 rounded-full object-cover border-4 border-blue-primary shadow-card"
            />
          </div>
        </div>
      </div>
